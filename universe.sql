...
--
-- Name: solar_system solar_system_contraint_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.solar_system
    ADD CONSTRAINT solar_system_contraint_key UNIQUE (contraint);
